        ...
        self.dimension_traits = {
            '开放性': {
                'high': {
                    ...
                    'color': 'rgb(99, 110, 250)'  # 蓝色
                },
                'low': {
                    'traits': '务实稳重、专注深入、重视经验',
                    'color': 'rgb(239, 85, 59)'  # 红色
                }
            },
            '尽责性': {
                'high': {
                    'traits': '有序规划、目标明确、注重效率',
                    'color': 'rgb(0, 204, 150)'  # 绿色
                },
                'low': {
                    'traits': '灵活机动、随机应变、自然随性',
                    'color': 'rgb(255, 161, 90)'  # 橙色
                }
            },
            '外向性': {
                'high': {
                    'traits': '活力充沛、善于社交、乐于表达',
                    'color': 'rgb(171, 99, 250)'  # 紫色
                },
                'low': {
                    'traits': '独立思考、专注内省、深度思维',
                    'color': 'rgb(253, 128, 177)'  # 粉色
                }
            },
            '宜人性': {
                'high': {
                    'traits': '善解人意、乐于合作、重视和谐',
                    'color': 'rgb(0, 182, 235)'  # 青色
                },
                'low': {
                    'traits': '独立自主、客观理性、重视效果',
                    'color': 'rgb(255, 102, 102)'  # 浅红色
                }
            },
            '情绪稳定性': {
                'high': {
                    'traits': '冷静理性、抗压坚韧、情绪稳定',
                    'color': 'rgb(112, 178, 0)'  # 黄绿色
                },
                'low': {
                    'traits': '敏锐感知、丰富情感、细腻体察',
                    'color': 'rgb(255, 194, 0)'  # 金色
                }
            }
        }
